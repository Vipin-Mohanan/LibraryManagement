...
export class InitialMigration1738737635646 implements MigrationInterface {
    name = 'InitialMigration1738737635646'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("user_id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "phone_number" integer NOT NULL, "address" character varying NOT NULL, "membership_date" TIMESTAMP NOT NULL DEFAULT now(), "membership_status" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_758b8ce7c18b9d347461b30228d" PRIMARY KEY ("user_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "book" ("book_id" SERIAL NOT NULL, "title" character varying NOT NULL, "author" character varying NOT NULL, "description" character varying NOT NULL, "publisher" character varying NOT NULL, "publication_year" character varying NOT NULL, "isbn" character varying NOT NULL, "copies_available" integer NOT NULL, "total_copies" integer NOT NULL, "images" bytea array, "category_id" integer, CONSTRAINT "PK_b66091a3d2edddc14f6b91fc606" PRIMARY KEY ("book_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "librarian" ("librarian_id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "phone_number" integer NOT NULL, "password" character varying NOT NULL, "address" character varying NOT NULL, "role" "public"."librarian_role_enum" NOT NULL DEFAULT 'librarian', CONSTRAINT "PK_7f219fcfb79e4d0837e90e231f0" PRIMARY KEY ("librarian_id"))`);
